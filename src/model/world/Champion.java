...
public abstract class Champion implements Damageable , Comparable{
	...
	public void setLocation(Point currentLocation) {
		//if (this.condition == Condition.ROOTED)
			// Here we should throw UnallowedMovementException
			//return;
	...
	public String toString() {
		...
		String info = 
				...
				"- Normal Attack Range: " + attackRange  + '\n' +
	...
	public abstract String myLeaderAbilityInfo();
